...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None):
    ...
    for name, param in model.named_parameters():
        ...
        if len(param.shape) == 1 or name.endswith(".bias") or name in skip_list or name.endswith(".gamma") or name.endswith(".beta"):
            group_name = "no_decay"
            this_weight_decay = 0.
        # elif 'dwconv' in name or 'downsample_layers' in name:
        # elif 'dwconv' in name:
        #     group_name = "conv_decay"
        #     this_weight_decay = weight_decay * 3
        else:
            group_name = "decay"
