...
import models.lranet as lranet
import models.granet as granet


def get_args_parser():
    parser = argparse.ArgumentParser('GatingNet training and evaluation script for image classification', add_help=False)
    ...
    parser.add_argument('--weight_decay_end', type=float, default=None,
                        help="""Final value of the weight decay. We use a cosine schedule for WD and using 
                        a larger decay by the end of training improves performance for ViTs.""")
...
def main(args):
    ...
    model = granet.__dict__[args.model](
